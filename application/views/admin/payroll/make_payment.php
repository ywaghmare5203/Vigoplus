...
<div class="row">
    <div class="col-sm-12">
        ...
        ?>
        <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/payroll/get_payment/<?php
                    ...
                    <div class="panel panel-custom fees_payment">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="">
                                ...
                                <input type="text" data-parsley-type="number" name="fine_deduction" id="fine_deduction" value="<?php
                            ...
                            <div class="">
                                ...
                                <input type="text"  disabled=""
                                       value="<?php echo $net_salary + $total_award; ?>" class="payment_amount form-control">
                            </div>
