<div class="panel panel-custom">
    ...
    <div class="modal-body wrap-modal wrap">
        <form id="form_validation" data-parsley-validate="" novalidate="" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/training/save_training/<?php
        ...
        ?>" method="post" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" data-parsley-type="number" name="training_cost" class="form-control" value="<?php
