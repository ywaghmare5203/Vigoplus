...
// die();
      ...
      //  $goal_achieve = $this->items_model->get_project_progress($v_goal_track->project_id, true);
...
<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="pull-right <?= $active == 3 ? 'active' : ''; ?>"><a
    ...
    <div class="tab-content bg-white">
                    ...
                    if (!empty($all_project)):foreach ($all_project as $v_project):
                        ...
                        if (!empty($status)) {
                            if ($status == 'overdue') { ?>
                                    ...
                                    <tr>
                                        ...
                                        if (!empty($client_info)) {
                                            if ($client_info->client_status == 1) {
                                                ...
                                                $statuss = lang('company');
                                            }
                                            $name = $client_info->name . ' ' . $statuss . ' ';
                                        } else {
                                            $name = '-';
                                        }
                                        ?>
                                        ...
                                        <td>
                                            ...
                                            <?php }
                                            if (!empty($can_delete)) { ?>
                                                <?= btn_delete('admin/projects/delete_project/' . $v_project->project_id) ?>
                                            <?php } ?>
                                            <?php if (!empty($can_edit)) { ?>
                                                <div class="btn-group">
                                ...
                                <?php } ?>
                            <?php } elseif ($v_project->project_status == $status) {
                                ?>
                                <tr>
                                    <?php
                                    $client_info = $this->db->where('client_id', $v_project->client_id)->get('tbl_client')->row();
        ...
        <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="create">
            <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" id="form"
                  action="<?php echo base_url(); ?>admin/projects/saved_project/<?php
                ...
                <div class="panel-body">
                    <div class="col-sm-7">
                        ...
                        <div class="form-group" id="border-none">
                            <label for="field-1" class="col-lg-3 control-label"><?= lang('assined_to') ?> <span
