    ...
    $(function () {
        ...
        $('input[id="same_as_company"]').click(function () {
            if (this.checked) {
                ...
                $("textarea[name='shipping_address']").val($("textarea[name='address']").val());
                $("input[name='shipping_city']").val($("input[name='city']").val());
                $("input[name='shipping_state']").val($("input[name='state']").val());
                $("input[name='shipping_country']").val($("input[name='country']").val());
                $(".shipping_info").attr('disabled', 'disabled');
            } else {
                $(".shipping_info").removeAttr('disabled');
            }
        });
        $('input[id="same_as_shipping"]').click(function () {
            if (this.checked) {
                $("input[name='billing_phone']").val($("input[name='shipping_phone']").val());
                $("input[name='billing_email']").val($("input[name='shipping_email']").val());
                ...
                $(".billing_info").attr('disabled', 'disabled');
            } else {

                $(".billing_info").removeAttr('disabled');
            }
        });
