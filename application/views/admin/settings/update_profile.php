...
<div class="row">
            ...
            <div class="panel-body">
                <form role="form" id="update_profile" enctype="multipart/form-data" style="display: initial"
                    ...
                    if ($profile_info->company > 0) {
                        ...
                        <div class="form-group">
                            <label
                                class="col-lg-4 control-label"><strong><?= ($client_info->client_status == 1 ? lang('email') : lang('company_email')) ?></strong>
                            </label>
                            <div class="col-lg-8">
                        ...
                        <div class="form-group">
                            <label
                                class="col-lg-4 control-label"><strong><?= ($client_info->client_status == 1 ? lang('address') : lang('company_address')) ?></strong>
                            </label>
                            <div class="col-lg-8">
                ...
                <form  data-parsley-validate="" novalidate="" role="form" id="change_password" style="display: initial"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input data-parsley-type="alphanum" data-parsley-trigger="keyup" type="password" class="form-control" name="password"
                                   placeholder="<?= lang('password_current_password') ?>"
                                   onchange="check_current_password(this.value)" required>
                            <span id="id_error_msg"><small
                                    style="padding-left:10px;color:red;font-size:10px"><?= lang('password_does_not_match') ?></small></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><strong><?= lang('new_email') ?></strong></label>
                        <div class="col-lg-8">
                            <input type="email" class="form-control" name="email" placeholder="<?= lang('new_email') ?>"
                                   required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-4 control-label"></label>
                        <div class="col-lg-8">
                            <button type="submit" id="change_email"
    ...
    <div class="col-sm-6 wrap-fpanel">
        <div class="panel panel-custom" data-collapsed="0">
            ...
            <div class="panel-body">
                <form role="form" data-parsley-validate="" novalidate="" id="change_password"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input data-parsley-type="alphanum" data-parsley-trigger="keyup" type="password"
                                   name="old_password" value="" class="form-control"
                                   placeholder="<?= lang('enter_your') . ' ' . lang('old_password') ?>"
                                   onchange="check_old_password(this.value)"/>
                            <span id="id_old_error_msg"></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-4 col-sm-5">
                            <button id="change_old_password" type="submit"
                ...
                <form role="form" data-parsley-validate="" novalidate="" id="change_password" style="display: initial"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input data-parsley-type="alphanum" data-parsley-trigger="keyup" type="password" class="form-control" name="password"
                                   placeholder="<?= lang('password_current_password') ?>"
                                   onchange="check_username_current_password(this.value)" required>
                            <span id="id_user_error_msg"></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"></label>
                        <div class="col-lg-8">
                            <button type="submit" id="change_username"
