    ...
    <div class="aside-inner">
        <nav data-sidebar-anyclick-close="" class="sidebar">
            ...
            <ul class="nav">
                ...
                ?>">
                    <a href="<?php echo base_url(); ?>client/projects"> <em
                            class="fa fa-folder-open-o"></em><span><?= lang('project') ?></span></a>
                </li>
                <li class="<?php
                if (!empty($page)) {
                    echo $page == lang('bugs') ? 'active' : '';
                }
                ?>">
                    <a href="<?php echo base_url(); ?>client/bugs"> <em
                            class="fa fa-bug"></em><span><?= lang('bugs') ?></span></a>
                </li>
                <li class="<?php
                if (!empty($page)) {
                ...
                ?>">
                    <a href="<?php echo base_url(); ?>client/quotations/"> <em
                            class="fa fa-paste"></em><span><?= lang('quotations') ?></span></a>
                </li>
                <li class="<?php
                if (!empty($page)) {
