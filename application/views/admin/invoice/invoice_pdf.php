    ...
    <tr>
        ...
        <td>
            <div id="company">
                ...
                <div><?= (config_item('company_city_' . $client_lang) ? config_item('company_city_' . $client_lang) : config_item('company_city')) ?>, <?= config_item('company_zip_code') ?></div>
    ...
    <tr>
        <td>
            <div id="client">
                ...
                <div class="address"><?= $client_info->city ?>, <?= $client_info->zipcode ?>,<?= $client_info->country ?></div>
        ...
        <td>
            <div id="invoice">
                ...
                <div class="date"><?= $language_info['invoice_date'] ?>:<?= strftime(config_item('date_format'), strtotime($invoice_info->date_saved)); ?></div>
                <div class="date"><?= $language_info['payment_due'] ?>:<?= strftime(config_item('date_format'), strtotime($invoice_info->due_date)); ?></div>
