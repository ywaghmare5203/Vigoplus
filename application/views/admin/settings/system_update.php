<form action="<?= base_url() ?>admin/auto_update" method="post">
    <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input required type="text"
                                   ...
                                   value="<?= config_item('purchase_key') ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 text-center">
                        <?php if ($current_version != $latest_version && $latest_version > $current_version) { ?>
                            ...
                            <div class="update_app_wrapper" data-wait-text="<?php echo lang('wait_text'); ?>"
                                ...
                                <input type="submit" value="<?php echo lang('update_now'); ?>">
...
//                $.post('admin/auto_update', {
//                    purchase_key: purchase_key,
//                    latest_version: latest_version,
//                    auto_update: true
//                }).done(function () {
//                    $.post('admin/auto_update/database', {auto_update: true}).done(function () {
