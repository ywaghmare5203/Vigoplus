    ...
    <section class="col-sm-9">
        ...
        <section class="panel panel-custom">
            ...
            <div class="panel-body">
                ...
                <form method="post" data-parsley-validate="" novalidate="" action="<?= base_url() ?>admin/invoice/update_payemnt/<?php
                ...
                ?>" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" data-parsley-type="number" required="" class="form-control" value="<?= $payments_info->amount ?>"
                                   name="amount">
                        </div>
                    </div>
