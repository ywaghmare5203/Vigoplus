            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu animated zoomIn">
                    ...
                    if ($invoice_info->allow_stripe == 'Yes') { ?>
                        <li><a href="#" id="customButton"><?= lang('stripe') ?></a></li>
    ...
    <script>
        ...
        $('#customButton').on('click', function (e) {
            ...
            handler.open({
                ...
                description: 'Payment For : #<?=$invoice_info->reference_no?>(<?= display_money($this->invoice_model->calculate_to('invoice_due', $invoice_info->invoices_id), $currency->symbol); ?>)',
                amount: <?= $this->invoice_model->calculate_to('invoice_due', $invoice_info->invoices_id) * 100; ?>,
            });
            e.preventDefault();
        });
