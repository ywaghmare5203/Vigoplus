                ...
                ?>" enctype="multipart/form-data" >  
                          ...
                          foreach ($formbuilder_data as $value) {
                            ...
                            <?php if ($field_type == 'paragraph'): ?>
                                <label class="control-label"><?php echo $value['label'] ?> <?php if (!empty($required)) { ?><span class="text-danger">*</span><?php } ?></label>
                                <div class="">
                                    <?php
                            ...
                            <?php if ($field_type == 'checkboxes'): ?>
                                ...
                                <div class="">
                                    ...
                                    foreach ($options as $v_option) {
                                        ...
                                        ?>
                                        <input type="checkbox" style="width: 15px;height: 15px;margin-right: 5px"  <?= $checked ?> ><?= $v_option['label'] ?>
                                    <?php } ?>
                                </div>                            
                                <br/>
                            <?php endif; ?>                            
                            <?php if ($field_type == 'radio'): ?>
                                ...
                                <div class="">
                                    ...
                                    foreach ($options as $v_option) {
                                        ...
                                        ?>
                                        <input type="radio" style="width: 15px;height: 15px;margin-right: 5px"  <?= $checked ?> ><?= $v_option['label'] ?>
                                    <?php } ?>
                                </div>                            
                                <br/>
                            <?php endif; ?>                            
