                ...
                <form method="post"
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('save_into_default_account') ?>
                            <i title="" class="fa fa-question-circle" data-toggle="tooltip" data-placement="top"
                               data-original-title="this transaction will deposit into your default account or the first account"></i>
                        </label>
                        <div class="col-lg-6">
                            <div class="checkbox c-checkbox">
                                <label>
                                    <input type="checkbox" class="custom-checkbox" name="save_into_default_account">
                                    <span class="fa fa-check"></span></label>
                            </div>
