            ...
            <div class="tab-pane <?= $active == 2 ? 'active' : '' ?>" id="assign_task" style="position: relative;">
                <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group">
                                <input required type="text" class="form-control   datepicker" name="purchase_date" value="<?php
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input required type="text" name="item_name" class="form-control" placeholder="" id="query"
                                   value="<?php
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input required type="text" data-parsley-type="number" name="inventory" placeholder="" class="form-control"
                                   value="<?php
