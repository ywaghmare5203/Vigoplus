    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content bg-white">
            ...
            <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="new">
                <form role="form" data-parsley-validate="" novalidate="" id="userform" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input data-parsley-type="alphanum" data-parsley-trigger="keyup" type="text" class="input-sm form-control" value="<?php
                            if (!empty($profile_info)) {
                    ...
                    ?> >
                        <label class="col-sm-3 control-label"><strong><?= lang('designation') ?> </strong><span
                                class="text-danger">*</span></label>
                        <div class="col-sm-5">
                            <select class="form-control select_box department" style="width: 100%"
