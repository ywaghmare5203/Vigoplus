        ...
        <div class="panel panel-custom">
            <div class="panel-heading">
                <?php if (!empty($can_edit)) { ?>
                    <a style="margin-top: -5px" href="<?= base_url() ?>admin/tickets/index/edit_tickets"
                       data-original-title="<?= lang('new_ticket') ?>" data-toggle="tooltip" data-placement="top"
                                ...
                                <ul class="nav"><?php
                                    ...
                                    ?>">
                                        <a href="<?= base_url() ?>admin/tickets/index/tickets_details/<?= $v_tickets_info->tickets_id ?>">
                                            ...
                                            <small class="block small text-muted"><?php if (!empty($user_info)) {
            ...
            <div class="row ">
                <div class="col-sm-12">
                    ...
                    <?php if (!empty($can_delete)) { ?>
                        <a href="<?= base_url() ?>admin/tickets/delete/delete_tickets/<?= $tickets_info->tickets_id ?>"
                           class="btn btn-danger btn-sm" title="" data-toggle="tooltip" data-placement="top"
                    ...
                    <div class="panel-body chat">
                        ...
                        <div id="topic-reply" class="collapse" aria-expanded="true">
                            <form method="post" enctype="multipart/form-data"
                                  action="<?= base_url() ?>admin/tickets/index/save_reply/<?= $tickets_info->tickets_id ?>">
                                            ...
                                            if (!empty($ticket_file)):
                                                ...
                                                foreach ($ticket_file as $t_files):
                                                    ...
                                                    if (!empty($t_files)):
                                                        ...
                                                        <a
                                                            href="<?= base_url() ?>admin/tickets/index/download_file/<?= $tickets_info->tickets_id . '/' . $t_files->fileName ?>">
                                                            <img style="width: 50px;border-radius: 5px;"
                                                                 src="<?= base_url() . $t_files->path ?>"></a></span>
                                                    <?php else: ?>
                                                        <a class="btn btn-default btn-file"
                                                           href="<?= base_url() ?>admin/tickets/index/download_file/<?= $tickets_info->tickets_id . '/' . $t_files->fileName ?>"><i
